	 ...
	 */
	 private function getNumLoggedIn() {
		...
		foreach ($procs as $proc) {
			...
			if (preg_match('/(?:ash|sh|bash|csh|zsh|ksh)$/', getContents($proc, ''))) {
