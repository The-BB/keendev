<?php
	...
	// draw title
	//$rxtx = shell_exec("/sbin/ifconfig ".$iface." |grep bytes");
	//$text = "ifconfig $iface: $rxtx";
	$text = "";
	svg_text($iw / 4, ($ytm / 2), $text, array( 'stroke' => $cl['text'], 'fill' => $cl['text']['rgb'],'stroke-width' => 0, 'font-family' => SVG_FONT, 'font-weight' => 'bold', 'text-anchor' => 'middle' ));
    }
